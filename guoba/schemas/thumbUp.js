export default [
  ...
  {
    field: "other.thumbUp.strangeThumbUp",
    label: "陌生人点赞",
    bottomHelpMessage: "开启后赞我功能将可以陌生人点赞，不活跃的号有可能被风控",
    component: "Switch"
  },
  {
    field: "other.thumbUp.cloneAllThumbUp",
    label: "关闭全部赞我",
    component: "Switch"
  },
  {
    field: "other.thumbUp.successMsg",
    label: "点赞成功消息",
